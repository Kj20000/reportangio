  ...
  const fillNormalValues = () => {
    ...
    if (formData.angiogramType === "CAG") {
      ...
      setFormData((prev: any) => ({
        ...
        rightFemoral: "Normal",
        leftFemoral: "Normal",
        rightPopliteal: "Normal",
        leftPopliteal: "Normal",
        rightATA: "Normal",
        leftATA: "Normal",
        rightPTA: "Normal",
        leftPTA: "Normal",
        rightPeroneal: "Normal",
        leftPeroneal: "Normal",
      ...
      setFormData((prev: any) => ({
        ...prev,
        ...baseNormal,
        rightRenalArtery: "Normal",
        leftRenalArtery: "Normal",
        rightRenalBranches: "Normal",
        leftRenalBranches: "Normal",
      ...
      setFormData((prev: any) => ({
        ...prev,
        ...baseNormal,
        rightCommonCarotid: "Normal",
        leftCommonCarotid: "Normal",
        rightInternalCarotid: "Normal",
        leftInternalCarotid: "Normal",
        rightExternalCarotid: "Normal",
        leftExternalCarotid: "Normal",
