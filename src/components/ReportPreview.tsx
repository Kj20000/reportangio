      ...
      <Card className="border-primary/20 shadow-lg print:border-none print:shadow-none print:bg-transparent" ref={previewRef}>
        <CardContent className="p-8 space-y-6 print:p-0 print:space-y-3">
          ...
          <div className="pt-8 border-t border-primary/20 space-y-6 print:pt-4 print:space-y-3 print-signature-section">
            <div className="grid grid-cols-4 gap-4 print:gap-2 text-left pt-16 print:pt-12">
              {/* Dr. Prakash Chandwani */}
              <div className="border-t border-foreground/30 pt-2 flex flex-col justify-between h-full">
                <div>
                  <p className="text-xs font-bold text-foreground uppercase tracking-tight print:text-[10px]">DR. PRAKASH CHANDWANI</p>
                  <p className="text-[10px] text-muted-foreground leading-tight mt-0.5 print:text-[9px]">MD, DM (Cardiology), FACC, FSCAI (USA), FESC</p>
                  <p className="text-[10px] text-muted-foreground leading-tight mt-0.5 print:text-[8px]">Chief Consultant Interventional Cardiologist</p>
                </div>
                <p className="text-[10px] font-semibold text-foreground mt-1 print:text-[8px]">(Director)</p>
              </div>

              {/* Dr. Kushal Jangid */}
              <div className="border-t border-foreground/30 pt-2 flex flex-col justify-between h-full">
                <div>
                  <p className="text-xs font-bold text-foreground uppercase tracking-tight print:text-[10px]">DR. KUSHAL JANGID</p>
                  <p className="text-[10px] text-muted-foreground leading-tight mt-0.5 print:text-[9px]">MD, DNB (CARDIOLOGY)</p>
                  <p className="text-[10px] text-muted-foreground leading-tight mt-0.5 print:text-[8px]">Consultant Interventional Cardiologist</p>
                </div>
              </div>
              ...
              <div className="border-t border-foreground/30 pt-2 flex flex-col justify-between h-full">
                <div>
                  <p className="text-xs font-bold text-foreground uppercase tracking-tight print:text-[10px]">DR. NITESH PANSARI</p>
                  <p className="text-[10px] text-muted-foreground leading-tight mt-0.5 print:text-[9px]">MD, DNB (CARDIOLOGY)</p>
                  <p className="text-[10px] text-muted-foreground leading-tight mt-0.5 print:text-[8px]">Consultant Interventional Cardiologist</p>
                </div>
              </div>
              ...
              <div className="border-t border-foreground/30 pt-2 flex flex-col justify-between h-full">
                <div>
                  <p className="text-xs font-bold text-foreground uppercase tracking-tight print:text-[10px]">DR. SANGEETA KUMARI CHOUDHARY</p>
                  <p className="text-[10px] text-muted-foreground leading-tight mt-0.5 print:text-[9px]">MBBS, DM (CARDIOLOGY)</p>
                  <p className="text-[10px] text-muted-foreground leading-tight mt-0.5 print:text-[8px]">Consultant Interventional Cardiologist</p>
                </div>
              </div>
            </div>
      ...
      <style>{`
        @media print {
          ...
          * {
          ...
          @page {
            size: A4;
            margin: ${printOnLetterhead ? "0mm 15mm 50mm 15mm" : "15mm 15mm 20mm 15mm"} !important;
          }
          /* Ensure signature section doesn't split awkwardly across pages */
